...
|-------|-------------|----------------|
| build-slides | Generate presentation slides with structured formats and themes | **Copy-paste this into your agent:** "Install the build-slides skill from https://github.com/kn-neeraj/agent-skills/blob/main/skills/build-slides/SKILL.md" |
...
| /read-sessions-summary | Read and browse session summaries from `docs/sessions/` | **Copy-paste this into your agent:** "Install the /read-sessions-summary command from https://github.com/kn-neeraj/agent-skills/blob/main/skills/read-sessions-summary/SKILL.md" |
...
│       ├── SKILL.md              # Agent workflow and instructions
│       └── generate-whiteboard-diagram.skill
├── summarise/
│   ├── SKILL.md              # Agent workflow and instructions
│   └── README.md             # Human-readable documentation
